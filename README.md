...
* `03_Library SystemCustomers.csv`: Book checkout and return transactions.
...
5. **Report:** Load the final `results.csv` into Power BI to visualize data health and metrics.
...
│   └── results.csv        # Cleaned output file used by Power BI
